...
describe "User address index page" do
  before :each do
    ...
    allow_any_instance_of(ApplicationController).to receive(:current_user).and_return(@user)
      ...
      @address_1 = Address.create(address_line: "1211 west 16th st", city: "Denver", state: "CO", zip: "80104",  nickname: "Home", user: @user)
      @address_2 = Address.create(address_line: "2033 north larimer st", city: "Chicago", state: "IL", zip: "80204", nickname: "Work", user: @user)
      @address_3 = Address.create(address_line: "2244 blake st", city: "Boston", state: "MA", zip: "80304", nickname: "Other", user: @user)
